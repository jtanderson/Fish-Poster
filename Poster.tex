	      ...
	      \item Euclidian Distance Comparison: 21.2\% recognition rate
            ...
            \begin{block}{Segmentation of \ref{fig:originalimage}}
             \begin{figure}
               ...
               \subfloat[Kitter's method without thinning]{ \includegraphics[scale=1]{figures/subdemokittler} }
               \subfloat[Tao's method without thinning]{ \includegraphics[scale=1]{figures/subdemotao} }
               \subfloat[Xiao's method without thinning]{ \includegraphics[scale=1]{figures/subdemoxiao} }
               
               \subfloat[Kitter's method with thinning]{ \includegraphics[scale=1]{figures/subdemokittlerthin} }
               \subfloat[Tao's method with thinning]{ \includegraphics[scale=1]{figures/subdemotaothin} }
               \subfloat[Xiao's method with thinning]{ \includegraphics[scale=1]{figures/subdemoxiaothin} }
             \end{figure}
            \end{block}
          }
        \end{minipage}
